...
4. [Full Variant Panels](#4-full-variant-panels-intelhqio)
5. [Tech Variant Panels](#5-tech-variant-panels-techintelhqio)
6. [Finance Variant Panels](#6-finance-variant-panels-financeintelhqio)
...
|---------|--------|-------|-------------|
| `full` | intelhq.io | Geopolitical intelligence, OSINT, defense | 37 |
| `tech` | tech.intelhq.io | Technology, AI/ML, startups, VC | 34 |
| `finance` | finance.intelhq.io | Markets, trading, macro, commodities | 29 |
...
## 4. Full Variant Panels (intelhq.io)
...
## 5. Tech Variant Panels (tech.intelhq.io)
...
## 6. Finance Variant Panels (finance.intelhq.io)
...
This ensures users switching between variant domains (e.g. from intelhq.io to tech.intelhq.io) get a clean default experience for the new variant.
